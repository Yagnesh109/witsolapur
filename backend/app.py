...
def register_alumni():
    ...
    # Basic Validation
    if not all([name, email, department, graduation_year, designation, company, image_file]):
        return jsonify({'success': False, 'message': 'All form fields and image are required.'}), 400
